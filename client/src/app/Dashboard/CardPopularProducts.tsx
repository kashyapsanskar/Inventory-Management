// import { useGetDashboardMetricsQuery } from "client/src/state/api";
...
const CardPopularProducts = () => {
  ...
  if (error) return <div className="m-5">Error fetching data: </div>;
  if (!dashboardMetrics || !dashboardMetrics.popularProducts) {
      return <div className="m-5">No popular products available.</div>;
  }
